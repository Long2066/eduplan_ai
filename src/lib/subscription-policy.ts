...
export const PLAN_CATALOG: Record<SubscriptionPlan, PlanCatalogItem> = {
  free: {
    ...
    trialGenerations: 0,
    description: "Phù hợp để trải nghiệm EduPlan AI và soạn nhanh các giáo án cơ bản.",
    benefits: [
      "Sử dụng AI tiêu chuẩn.",
      "3 lượt tạo giáo án miễn phí mỗi ngày.",
      "Tự động reset lúc 00:00 theo giờ Việt Nam.",
      "Đầy đủ cấu trúc KHBD và bộ kiểm tra sư phạm.",
      "Lưu lịch sử và xuất giáo án Word.",
      "Phù hợp để trải nghiệm và soạn các bài học cơ bản.",
    ],
    cta: "Tiếp tục miễn phí",
    hint: "Cần nội dung chuyên sâu hơn, bám sát nhu cầu thực tế hơn? Gói Giáo viên sắp ra mắt đang được trải nghiệm 1 lượt tạo mỗi ngày.",
  },
  plus: {
    id: "plus",
    name: "Trả phí",
    badge: "TRẢ PHÍ (THỬ NGHIỆM)",
    title: "Trả phí – Chất lượng cao",
    priceVnd: 59_000,
    listPriceVnd: 79_000,
    includedCredits: 50,
    generationCost: 10,
    trialGenerations: 0,
    description: "Phù hợp với giáo viên muốn có giáo án rõ ràng, tự nhiên, bám sát yêu cầu bài dạy. Giáo án chỉn chu hơn và chất lượng hơn.",
    benefits: [
      "Sử dụng model AI cao cấp để soạn KHBD.",
      "Nội dung mạch lạc – ổn định – chất lượng hơn rõ rệt.",
      "Bám sát mục tiêu, hoạt động và đánh giá.",
      "Diễn đạt tự nhiên, giúp giảm thời gian chỉnh sửa.",
      "Quyền sử dụng trong 30 ngày.",
      "Soạn tối đa 5 giáo án với 50 tín dụng, có thể mua thêm tín dụng (nếu có).",
      "Đầy đủ công cụ lưu và xuất giáo án.",
    ],
